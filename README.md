...
*   **Invisible Scrollbars**: Both the left and right sidebars are configured to be scrollable when their content exceeds their height, but their scrollbars are visually hidden to maintain a clean aesthetic. The central dashboard's main content area retains its scrollbar for clarity of content overflow.
